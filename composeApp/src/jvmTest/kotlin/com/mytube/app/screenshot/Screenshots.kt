...
class Screenshots {
    ...
    fun renderEveryScreen() {
        ...
        renderer.render("home-feed", EnglishStrings) {
            HomeContent(HomeState.Ready(feed(), "t1"), "", {}, {}, {})
        }
    ...
    private fun feed() = listOf(
        video(
            ...
            "CBC News", 451, 157_000,
        ),
        video("Kidu9qrRV6o", "Eminem — Full Dark Symphonic Orchestra Cover | Cinematic & Intense", "ORKESTRAL", 218, 40_800),
        video("aaa", "A short one", "Lofi Girl", 42, 980),
        video("bbb", "Three hours of something, and a title long enough to be cut off after two lines on a phone screen", "NASA", 10_801, 4_730_000),
    )

    private fun video(id: String, title: String, channel: String, seconds: Int, views: Long) = Video(
        id = id,
        title = title,
        channel = Channel(id = channel, name = channel, handle = "@$channel", avatarPath = ""),
